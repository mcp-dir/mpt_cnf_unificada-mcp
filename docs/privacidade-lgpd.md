...
MPT Unificada: Certidão Negativa de Feitos segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [mpt_cnf_unificada@mcp.ai](mailto:mpt_cnf_unificada@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
